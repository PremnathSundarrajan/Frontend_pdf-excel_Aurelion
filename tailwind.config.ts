  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Teal palette - AI highlights & progress
        teal: {
          50: "hsl(var(--teal-50))",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px -5px hsl(180 55% 42% / 0.3)" },
          "50%": { boxShadow: "0 0 30px -5px hsl(180 55% 42% / 0.5)" },
        },
      },
      animation: {
